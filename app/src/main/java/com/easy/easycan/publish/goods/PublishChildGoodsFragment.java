package com.easy.easycan.publish.goods;
 ...
 * description 发布-常发货源
 */
public class PublishChildGoodsFragment extends BaseFragment {
  ...
  @Override protected int getLayoutId() {
    return R.layout.fragment_publish_goods_child;
  }
  @Override
  protected void initView(View view) {
    ...
    LinearItemDecoration  itemDecoration = new LinearItemDecoration(QMUIDisplayHelper.dp2px(getActivity(), 10));

package com.easy.easycan.util.img;
...
import com.easy.easycan.util.img.config.GlideConfigImpl;
import com.easy.easycan.util.img.progress.EasyGlideApp;
import com.easy.easycan.util.img.progress.GlideImageViewTarget;
import com.easy.easycan.util.img.progress.GlideRequest;
import com.easy.easycan.util.img.progress.GlideRequests;
import com.easy.easycan.util.img.progress.OnProgressListener;
import com.easy.easycan.util.img.progress.ProgressManager;
import com.easy.easycan.util.img.transformation.BlurTransformation;
import com.easy.easycan.util.img.transformation.BorderTransformation;
import com.easy.easycan.util.img.transformation.CircleWithBorderTransformation;
import com.easy.easycan.util.img.transformation.GrayscaleTransformation;
import com.easy.easycan.util.img.transformation.RoundedCornersTransformation;
...
public class EasyGlide {
    public static int placeHolderImageView = R.color.colorAccent;
    public static int circlePlaceholderImageView = R.color.colorAccent;
